...
| P2-01 | World Builder pre-pass: trích T1–T4 từ text trắng, pilot ch02 TI | READY | — | — | Task ĐẦU TIÊN gọi LLM thật (key: env hoặc `API-KEY.txt` root, đã gitignore); pilot `ch02` (ch01 chỉ là trang ngăn phần — CodeX phát hiện); **go/no-go #1: json_fail_rate < 5%**; Span Resolver/persist/FREEZE = P2-02 |
