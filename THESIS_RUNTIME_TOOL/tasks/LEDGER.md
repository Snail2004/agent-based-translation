...
| P2-02 | Fix prompt + re-run pilot + Span Resolver + persist T1–T4 + FREEZE | READY | — | — | Vá trọn 6 findings P2-01 §6; trigger SQLite enforce FREEZE cấp DB; relations → timeline valid_from/to theo order_index; re-run ~12k token |
