...
| P4-02 | Context Builder (anchor → hard constraints) + chạy S1 + số S0/S1/oracle | READY | — | — | Câu hỏi trung tâm lần đầu có số: S1 TAR vs 0.4151 (S0) vs 0.6226 (oracle); keyed-lookup SQLite thuần (Chroma để P4-04); Coverage Checker + dropped_by_budget vào pack; mẫu bắt buộc: b005 dead man's chest |
