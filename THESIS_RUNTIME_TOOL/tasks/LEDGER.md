...
| EV-02 | Trục ngữ nghĩa/văn phong: judge Gemini (pairwise A/B + GEMBA) + MATTR + hiệu chuẩn | READY | — | — | Trục bù cho TAR (đo "đúng nghĩa/hay"); judge cross-provider Gemini; pairwise chủ lực + GEMBA 4 tiêu chí phụ + MATTR tất định + **Spearman ρ vs người (bắt buộc — CodeX bản đầu bỏ sót)**; cần GEMINI key cho run thật; COMET→EV-03 |
