...
| P3-01 | S0 end-to-end: windower + dịch ch02+ch03 + đo S0-vs-oracle cùng thước | READY | — | — | **Milestone "dịch được" của GVHD**; window theo LOCK (u), prompt S0 trần (Newmark style policy, cấm adaptation); scoring reuse EV-01 + cùng provider (caveat #3 đóng); fix apostrophe ở tầng adapter; ~60–80k token |
