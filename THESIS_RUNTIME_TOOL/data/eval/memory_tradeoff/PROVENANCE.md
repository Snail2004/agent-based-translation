...
| judgments_claude.json | Claude-Opus-4.6 | cold Antigravity session | CROSS-FAMILY independent confirmation |

Headline finding = majority vote of the 3 cold model-diverse blind judges
(3.1pro_cold, 3.5flash_cold, opus46_cold) -> see data/reports/memory_tradeoff_panel.json.
