...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Normalize one HTML file into tool-compatible document and structure artifacts"
    )
    ...
    document_path, manifest_path = write_html_normalization(result, args.output_dir)
