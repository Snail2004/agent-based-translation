...
from pipeline.literary.b2_phase_a_v3 import dry_render_real_b1_run_v3
...
DEFAULT_SOURCE_RUN = (
    ...
    / "data"
    / "reports"
    / "literary_context_pipeline_ch01_ch02_openai_key1_gpt54_samehead_20260719_174712"
    / "b1_cycle"
)
DEFAULT_PROFILE = (
    RUNTIME_ROOT
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Render the Literary B2 slim Phase-A request set without API calls."
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    report = dry_render_real_b1_run_v3(
