...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Normalize one Markdown file into canonical document and structure artifacts"
    )
    ...
    document_path, manifest_path = write_markdown_normalization(result, args.output_dir)
