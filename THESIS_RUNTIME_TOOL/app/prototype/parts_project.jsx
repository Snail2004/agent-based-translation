      ...
      <div className="project-wrap">
        <div className="project-headline">
          ...
          <div className="source-state">
            ...
            <div className="srcstat-row"><span className={"ss-dot " + (sourcePackageStatus?.source ? "ok" : "bad")} /><span className="ss-label">{uiText("Nguồn", "Source")}</span><span className="ss-val mono">{sourcePackageLoading ? uiText("đang xác minh…", "validating…") : sourcePackageError ? uiText("chưa xác định", "unknown") : sourcePackageStatus?.source ? `${sourcePackageStatus.source.format} · ${sourcePackageStatus.source.filename}` : uiText("thiếu", "missing")}</span></div>
